...
| NFR-010's 2-second performance budget is unverified and may fail on typical hardware | Medium | Medium | Benchmark `llama3.1` inference time as the first concrete step of implementation, before building further UI around an unconfirmed latency assumption |
