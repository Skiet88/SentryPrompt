...
| **1B** | **Revise SPECIFICATION.md Individual Scope** *(new — scope expansion)* | P1, P4 | Short revision to §1.3: acknowledge Agile-driven expansion to full platform, restate feasibility with the larger footprint (accept realistic timeline trade-offs) | §1.3 Project Scope, §2.2 Justification of Chosen Approach | ⬜ Not started | **High — do before writing anything client-facing** |
...
| 2 | Use Case Modeling & Test Case Development *("Assignment 5")* | P3, P9 | USE_CASES.md (diagram + specs), TEST_CASES.md | §4.3 Sequence/Interaction Diagram (required diagram type #2), §3.1.2 Component Interactions, seeds §9 testing strategy | ✅ Done | — |
...
| 4B | **Auth & Account Module Design** *(new — scope expansion)* | P3, P5, P6 | AUTH_DESIGN.md — registration/verification/login/reset flows, session handling approach, admin-panel access boundary | §3.2.1 Module Specs, §8.1.3 Module Decomposition | ⬜ Not started | High |
...
| 5 | Data Model: ERD & AI Data Pipeline *(merges App Dev §8.1.2 + AI/DS §8.3.2)* | P3, P5 | ERD.md/diagram (now covering all 14 entities, including User/Session/Conversation/Message relationships), DATA_PIPELINE.md | §4.4 Data/ERD Diagram (required diagram type #4), §8.1.2, §8.3.2 | ⬜ Not started | High |
